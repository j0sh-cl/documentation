...
date: Last Modified
sdkLang: "ts"
pageId: "reference-sdk-type-conversions"
metadata:
...
| --- | --- | --- | --- |
| `bytes` | `Uint8Array` | `string` (base64) | Use [`hexToBase64()`](/cre/reference/sdk/evm-client-ts#hextobase64) and [`base64ToHex()`](/cre/reference/sdk/evm-client-ts#base64tohex) to convert between hex and base64. |
